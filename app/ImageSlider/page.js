        ...
        >
            ...
            <div className="relative z-[3]">
                <motion.h1
                    ...
                    className={`${pacifico.className} text-3xl md:text-6xl mb-4 text-[#FF6600]`}
                >
                    {currentSlide.title}
                </motion.h1>
                ...
                <motion.h3
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1.2, delay: 0.3 }} // slightly delayed
                    className={`${pacifico.className} text-xl md:text-3xl mt-2 max-w-xl`}
                >
